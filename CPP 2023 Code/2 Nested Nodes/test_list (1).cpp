...
template <typename T>
void PrintList(const List<T>& L, string label)
{
   cout << label << " size is: " << L.size() << "\n"
        << label << " = ";
   L.print(cout);
   cout << "\n\n";
}
...
int main() {
	...
	PrintList(myList,"L1");
    // Use an iterator to go through the list and print the numbers
