...
int main(void)
{
    ...
    string instr = "10 5 + 6 4 + / 4 +";
    cout<<"Enter in a postfix notation: " << instr << "\n";
    cout<<"infix notation: ";
    //getline(cin, instr);
    myinfix1.buildFromPostfix(instr);
    myinfix1.printInfixExpression();

    string instr2 = "10 5 6 4 +  4 +";
    cout<<"Using the string " << "' " << instr2 << " '" << " we get the error: \n";
    cout<<"infix notation: ";
    myinfix5.buildFromPostfix(instr2);
    myinfix5.printInfixExpression();
